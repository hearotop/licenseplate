...
public class LoginAuth {
    ...
    public boolean authenticate() {
        ...
        UserUrl="http://localhost:5000/get_userinfo?"+"username="+username+"&password="+encryptPassword(password);
        try {
            ...
            if (responseCode==HttpURLConnection.HTTP_OK) {
                ...
                boolean isAuthenticated = jsonResponse.getBoolean("authentFlag"); // 假设JSON响应中包含一个布尔字段"authenticated"
